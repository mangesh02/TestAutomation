...
@CucumberOptions(plugin = { "pretty","json:target/cucumber.json" }, glue = {
		"automation.stepdefs", "browsers"  }, features = "src/test/resources/features", monochrome = true, tags = {
				"@androidbrowser", "~@androidapp" }) // "pretty",
